...
defmodule TEST.Config3 do
  ...
  use ScreensConfig.Struct, children: [daughter: TEST.Config1, son: TEST.Config2]
end
...
defmodule TEST.Config4 do
  ...
  use ScreensConfig.Struct, children: [daughter: TEST.Config1, sons: {:list, TEST.Config2}]
end
...
defmodule TEST.Config5 do
  ...
  use ScreensConfig.Struct, children: [daughter_map: {:map, TEST.Config1}, son: TEST.Config2]
end
...
defmodule TEST.Config6 do
  ...
  use ScreensConfig.Struct, children: [child: TEST.Config2]
